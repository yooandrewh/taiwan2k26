 ...
 *
 * WHAT IT DOES
 *   POST  {person,pin,edited,g,ev,vbs,tmf,hs,gcl,ds,lp,eric,last}
 ...
 *           are in each section, which sign-ups are ticked, when it was last
 *           edited.  No answer text ever leaves the sheet through this call —
 *           that's what lets the app show a team status board without breaking
 *           the privacy promise.
 */
